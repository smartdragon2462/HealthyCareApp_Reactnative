  ...
  render() {
    ...
    if (marking) {
      ...
      if (flags.startingDay && !flags.endingDay) {        
        ...
        rightFillerStyle = {
          backgroundColor: flags.startingDay.color==="#29D19E"? "#D4FCE0":"#E6F0FF",  //this.theme.selectedDayFillColor //flags.startingDay.color
        };
        containerStyle.push({
        ...
        leftFillerStyle = {
          backgroundColor: flags.endingDay.color==="#29D19E"? "#D4FCE0":"#E6F0FF",  // this.theme.selectedDayFillColor //flags.endingDay.color
        };
        containerStyle.push({
    ...
    const {marking: {marked, dotColor, disableTouchEvent}, theme, accessibilityLabel, testID, date} = this.props;
    let isDotmark = false;
    if(textStyle[1].color==="#99A1AD" || date.weekday===0 || date.weekday===6) isDotmark = false;
    else isDotmark = true;
    if(marked) isDotmark = true;
      ...
      >
        <View style={this.style.wrapper}>
          ...
          <View style={[{backgroundColor:"transparent"}, containerStyle]}>
            ...
            <Dot
              theme={theme}
              color={dotColor? dotColor:"#0066FF"}
              marked={isDotmark} //marked
            />
          </View>
        </View>
      </TouchableWithoutFeedback>
