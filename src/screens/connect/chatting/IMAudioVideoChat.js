...
// import { Dimensions, DeviceEventEmitter, NativeModules, AppState, Platform, Alert,} from 'react-native';
...
// import {  setMediaChatReceivers,  signalChatRoomParticipants,  deletePrevSignalledParticipants,} from './firebase';
...
//     const userId = user.id || user.userID;
//     this.mediaChatTracker.subscribeCallConnectionData({ channelId, userId },  this.onCallConnectionDataSubscribe, );
//   };

//   ///////////////////////////////////////////////////////////////////////////////////////
//   handleIncomingCall = () => {
//     if (this.state.isForeground && !this.callAccepted) {
//       this.setState({ isComInitiated: false,  });
//       InCallManager.startRingtone('_DEFAULT_');
//     }
...
//     const { audioVideoChatReceivers,user,channelId,channelTitle, } = this.props;
...
//       return;
//     }
//     const { user, channelId,  channelTitle, audioVideoChatReceivers, } = this.props;
//     const currentDate = new Date();
//     const currentMiliSeconds = currentDate.getTime();
//     const newData = {
//       receiverId,
...
//       const userId = user.id || user.userID;
//       const messageData = { senderId: userId, receiverId: senderId, type: chatType, channelId: channelId, };
...
//   render() {
//     const {  remoteStreams, localStream, isComInitiated, peerConnectionStarted, isMuted,isSpeaker, } = this.state;
//     return (
//       <Modal 
